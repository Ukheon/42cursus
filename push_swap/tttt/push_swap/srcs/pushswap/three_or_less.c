...
void			case_a_three(t_info *info, int *temp)
{
...
// {
// 	if (info->remain_arr[info->remain_idx] == 3)
// 	{
// 		printf("check = %d\n", g_check);
// 		case_a_three(info);
...
// 		// 	repeat_cmd(info, 3, "ra\n");
// 	}
// 	else if (info->remain_arr[info->remain_idx] == 2)
// 	{
...
// 			repeat_cmd(info, 2, "ra\n");
// 	}
// 	else if (info->remain_arr[info->remain_idx] == 1)
